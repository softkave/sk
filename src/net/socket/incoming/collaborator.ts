...
function handleUpdateCollaborator(packet: IIncomingResourceUpdatePacket<ICollaborator>) {
...
function handleDeleteCollaborator(
  ...
  assert(room.type === SystemResourceType.Workspace, appMessages.internalError);
