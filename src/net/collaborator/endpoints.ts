...
async function getOrganizationCollaborators(props: IGetOrganizationCollaboratorsEndpointParams) {
  return invokeEndpointWithAuth<IGetOrganizationCollaboratorsEndpointResult>({
    path: `${baseURL}/getOrganizationCollaborators`,
    data: getOrganizationCollaboratorsYupSchema.validateSync(props, endpointYupOptions),
    apiType: "REST",
  });
}
...
export default class CollaboratorAPI {
  static getOrganizationCollaborators = getOrganizationCollaborators;
