...
async function addSprint(params: IAddSprintAPIParams): Promise<IAddSprintAPIResult> {
...
async function updateSprint(params: IUpdateSprintAPIParams): Promise<IUpdateSprintAPIResult> {
...
async function sprintExists(params: ISprintExistsAPIParams): Promise<ISprintExistsAPIResult> {
...
export default class SprintAPI {
  ...
  static getSprints = getSprints;
  static sprintExists = sprintExists;
}
