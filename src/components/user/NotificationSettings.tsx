...
const NotificationSettings: React.FC<INotificationSettingsProps> = (props) => {
    ...
    return (
      <div className={classes.root}>
        <Typography.Paragraph>
          ...
          <Typography.Text strong>Service Workers</Typography.Text>, a feature
          we use to implement notifications. To fix this, try updating your
          browser.
        </Typography.Paragraph>
      </div>
    );
  ...
  if (!supportsNotification()) {
    return (
      <div className={classes.root}>
        <Typography.Paragraph>
          Your browser does not support notifications. To fix this, try updating
          your browser.
        </Typography.Paragraph>
      </div>
    );
  ...
  if (permission.isDenied || permission.isDefault) {
    return (
      <div className={classes.root}>
        <Typography.Paragraph>
          You currently don't have notifications turned on, so we won't be able
          to notify you through this browser when you get messages and you're
          not currently on the app. To change this, click the "Request
          Permission" button below.
        </Typography.Paragraph>
        <Button
          type="primary"
      ...
      return (
        <div className={classes.root}>
          <Typography.Paragraph style={{ maxWidth: "520px" }}>
            So, you've granted us permission to show notifications, but we
            weren't able complete the process. You can retry the process by
  ...
  return (
    <div className={classes.root}>
      <Typography.Paragraph>
        If you're seeing this page, then there's a bug in our code. Please
        report this to us using the Feedbacks form nicely tucked away around
        where you logout from the app.
      </Typography.Paragraph>
    </div>
  );
};
