  ...
  return (
    <Modal visible footer={null} closable={false} title={null}>
      <Typography.Paragraph className={css({ textAlign: "center" })}>
        Hi <Typography.Text strong>{user.name}</Typography.Text>, we recently
        made changes to the app to notify you when you have new messages and not
        currently viewing the app, but we would need your permission to show
        notifications through your browser.
