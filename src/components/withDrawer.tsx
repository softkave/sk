...
>(
  ...
  > {
    ...
    constructor(props) {
      super(props);
      this.updateWindowData = throttle(this.updateWindowData, windowResizeThrottleSpeedMs);
  ...
  const displayName = `withDrawer(${component.displayName || component.name || "Component"})`;
