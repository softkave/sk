...
import wrapMenu from "../utils/wrapMenu";
...
const MenuWithTrigger: React.FC<IMenuWithTriggerProps> = (props) => {
  const { menuType, menuTitle, renderMenu, renderTrigger, dropdownPlacement } = props;
  ...
  const renderOptionsDrawer = (
    ...
    return (
      <Drawer visible closable title={title} placement="right" onClose={onClose} width={300}>
        <div
          style={{
