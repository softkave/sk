...
import { getAverageTimeToCompleteTasksOpAction } from "../../redux/operations/block/getAverageTimeToCompleteTasks";
...
const BoardStats: React.FC<IBoardStatsProps> = (props) => {
    ...
    const avgTimeToCompleteTasks = useSelector<IAppState, number | undefined>(
        (state) =>
            BlockSelectors.getBlock(state, board.customId)
                .avgTimeToCompleteTasks
    );
