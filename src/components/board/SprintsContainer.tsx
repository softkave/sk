...
const SprintsContainer: React.FC<ISprintsContainerProps> = (props) => {
  const { board, onUpdateSprint, onClickUpdateTask: onClickUpdateBlock } = props;
  ...
  const wrappedOnUpdateSprint = React.useCallback(
    (sprintId: string) => onUpdateSprint(sprints.find((item) => item.customId === sprintId)!),
...
const DELETE_SPRINT_PROMPT_MESSAGE = "Are you sure you want to delete this sprint?";
const YES = "Yes";
const NO = "No";
const START_SPRINT_PROMPT_MESSAGE = "Are you sure you want to start this sprint?";
