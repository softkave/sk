...
export const orgResourceTypesToActionsMap =
  getResourceTypeToActionsMapByResourceTypeList(orgResourceTypes);

export const boardResourceTypesToActionsMap =
  getResourceTypeToActionsMapByResourceTypeList(boardResourceTypes);

export const orgResourceTypesToActionList =
  getPermissionsListFromResourceTypeToActionsMap(orgResourceTypesToActionsMap);
