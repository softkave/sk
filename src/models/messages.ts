export const appMessages = {
  ...
  invalidCredentials: "You've provided an invalid credential, maybe try loggin in again",
  ...
  invalidLoginCredentials: "You've entered an incorrect email address or password",
