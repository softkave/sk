...
export let appLocalStorage = storageAvailable("localStorage") ? window.localStorage : null;
export let appSessionStorage = storageAvailable("sessionStorage") ? window.sessionStorage : null;
